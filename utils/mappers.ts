...
export const mapReflectionToState = (reflection: any): WellnessState => {
  const stateData: WellnessState = {
    ...
    hydration: reflection.hydration || 0,
    "morning-vitality": reflection.morning_vitality || 0,
    "afternoon-vitality": reflection.afternoon_vitality || 0,
    "evening-vitality": reflection.evening_vitality || 0,
